...
use Lolli\Dbdoctor\HealthCheck\TcaTablesTranslatedLanguagePageTranslationMissing;
...
class TcaTablesTranslatedLanguagePageTranslationMissingTest extends FunctionalTestCase
{
    ...
    public function showDetails(): void
    {
        ...
        $this->importCSVDataSet(__DIR__ . '/../Fixtures/TcaTablesTranslatedLanguagePageTranslationMissingImport.csv');
        $io = $this->createMock(SymfonyStyle::class);
        /** @var TcaTablesTranslatedLanguagePageTranslationMissing $subject */
        $subject = $this->get(TcaTablesTranslatedLanguagePageTranslationMissing::class);
    ...
    public function fixBrokenRecords(): void
    {
        ...
        $this->assertCSVDataSet(__DIR__ . '/../Fixtures/TcaTablesTranslatedLanguagePageTranslationMissingFixed.csv');
    }
